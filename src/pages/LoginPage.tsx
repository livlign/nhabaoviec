  ...
  return (
    <div className="grain flex min-h-screen items-center justify-center px-4">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -top-1/4 -right-1/4 h-[600px] w-[600px] rounded-full bg-lacquer/5 blur-[120px]" />
        <div className="absolute -bottom-1/4 -left-1/4 h-[400px] w-[400px] rounded-full bg-gold/5 blur-[100px]" />
      </div>
      ...
      <div className="relative w-full max-w-sm">
        <div className="mb-10 text-center slide-up">
          ...
          <p className="mt-2 text-sm text-parchment-faint">Sign in to Nha Bao Viec</p>
        </div>
        ...
        <p className="slide-up stagger-3 mt-6 text-center text-sm text-parchment-faint">
          ...
          <Link to="/signup" className="font-medium text-lacquer-light hover:text-lacquer transition-colors">
            Create one
          </Link>
        </p>
      </div>
